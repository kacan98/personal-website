  ...
  sideColumn: [
    ...
    },
    {
      ...
      bulletPoints: [
        ...
        {
          iconName: "gitHub",
          text: "Portfolio (Next.js/React + Sanity CMS)",
...
export async function getCVPicture(): Promise<string | null> {
  return cvConfig.profilePicture || null;
}